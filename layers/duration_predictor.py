...
from layers.normalization import LayerNorm, LayerNorm2
from layers.transformer import piecewise_rational_quadratic_transform
...
def generate_path(duration, mask):
    """  convert duration to duration attention
    Shapes:
